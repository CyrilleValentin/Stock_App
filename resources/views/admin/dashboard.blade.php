                ...
                <ul>
                        ...
                        <template x-if="isPagesMenuOpen">
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <li
                                    ...
                                    <a class="w-full" href="{{ route('admin.ajout') }}">Nouvelle Montre</a>
                                </li>
                                <li
                                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                    ...
                    <li class="relative px-6 py-3">
                        <button
                            ...
                            <span class="inline-flex items-center">
                                <i class='bx bxs-group text-2xl font-semibold'></i>
                        ...
                        <template x-if="isPagesMenuOpen1">
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <li
                                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                    <a class="w-full" href="{{ route('admin.listeUtil') }}">Liste du Personnel</a>
                                </li>
                                <li
                                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                    <a class="w-full" href="{{ route('admin.liste') }}">Liste des Agents</a>
                                </li>
                            </ul>
                        </template>
                ...
                <ul>
                    ...
                    <li class="relative px-6 py-3">
                        <button
                            ...
                            @click="togglePagesMenu" aria-haspopup="true">
                            <span class="inline-flex items-center">
                                <i class='bx bxs-watch-alt text-2xl font-semibold'></i>
                                <span class="ml-4">Montres</span>
                            </span>
                            <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                        ...
                        <template x-if="isPagesMenuOpen">
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <li
                                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                    <a class="w-full" href="{{ route('admin.liste') }}">
                                        Liste de Montres
                                    </a>
                                </li>
                                <li
